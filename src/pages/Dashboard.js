...
<div className="userdash-profile-section">
              <table className="userdash-profile-table">
                <tbody>
                  <tr>
                    <td className="userdash-profile-label">Name</td>
                    <td><strong>{user?.name || 'N/A'}</strong></td>
                  </tr>
                  <tr>
                    <td className="userdash-profile-label">Email</td>
                    <td>{user?.email || 'N/A'}</td>
                  </tr>
                  <tr>
                    <td className="userdash-profile-label">Mobile</td>
                    <td>{user?.phone || user?.mobile || 'N/A'}</td>
                  </tr>
                  <tr>
                    <td className="userdash-profile-label">Role</td>
                    <td>
                      <span className={`userdash-role-badge userdash-role-${user?.role || 'user'}`}>
                        {user?.role || 'user'}
                      </span>
                    </td>
                  </tr>
                  <tr>
                    <td className="userdash-profile-label">Joined</td>
