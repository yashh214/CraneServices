        ...
        <div className="vps-admin-cranes-main">
          ...
          <div className="vps-admin-cranes-controls">
            ...
            <button 
              ...
              onClick={() =>
                setCraneForm({ show: true, isEdit: false, data: {} })
              }
            >
              + Add New Crane
            </button>
                ...
                <tr key={c._id}>
                  ...
                  <td>
                    ...
                    <button 
                      ...
                      onClick={() =>
                        setCraneForm({ show: true, isEdit: true, data: c })
                      }
                    >
                      ✏️ Edit
                    </button>
              ...
              <div className="vps-admin-modal">
                <div className="vps-admin-modal-header">
                  ...
                  <button 
                    ...
                    onClick={() => setCraneForm({ ...craneForm, show: false })}
                  >
                    ×
                  </button>
                </div>
                ...
                <form className="vps-admin-modal-form">
                  ...
                  <div className="vps-admin-modal-actions">
                    <button 
                      ...
                      type="button"
                      onClick={() => setCraneForm({ show: false, isEdit: false, data: {} })}
                    >
                      Cancel
                    </button>
                    <button 
